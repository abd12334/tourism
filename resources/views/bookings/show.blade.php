    ...
    <table>
        ...
        <tbody>
                <tr>
                    ...
                    <td>{{ $booking->date }}</td>
                    <td><a href="{{ Route('bookings.edit', ['booking' => $booking->id]) }}"><img style="width: 30px"
                                ...
                                alt=""></a></td>
                    <td><a href="{{Route('bookings.destroy',['booking'=>$booking->id])}}"><img style="width: 30px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgxgk2JJECcveyd80tbCtE3TwsNj-WlmUApw&usqp=CAU" alt=""></a></td>
                </tr>
        </tbody>
    </table>
    <br>
