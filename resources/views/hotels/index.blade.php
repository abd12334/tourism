...
<body>
        ...
        <tbody>
            @foreach ($hotels as $hotel)
                <tr>
                    ...
                    <td><a href="{{ Route('hotels.edit', ['hotel' => $hotel->id]) }}"><img style="width: 30px"
                                ...
                                alt=""></a></td>
                    <td><a href="{{Route('hotels.destroy',['hotel'=>$hotel->id])}}"><img style="width: 30px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgxgk2JJECcveyd80tbCtE3TwsNj-WlmUApw&usqp=CAU" alt=""></a></td>
                </tr>
            @endforeach
        </tbody>
    </table>
    <br>
    <button>
        <a href="{{route('hotels.create')}}">Add Company</a>
    </button>
    <a href="/home">Home</a>
