        ...
        <tbody>
            @foreach ($customers as $customer)
                <tr>
                    ...
                    <td><a href="{{ Route('edit.customer', ['id' => $customer->id]) }}"><img style="width: 30px"
                                ...
                                alt=""></a></td>
                    <td><a href="{{Route('delete.customer',['id'=>$customer->id])}}"><img style="width: 30px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgxgk2JJECcveyd80tbCtE3TwsNj-WlmUApw&usqp=CAU" alt=""></a></td>
                </tr>
            @endforeach
        </tbody>
    </table>
