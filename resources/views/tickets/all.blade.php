        ...
        <tbody>
            @foreach ($tickets as $ticket)
                <tr>
                    ...
                    <td>{{ $ticket->date_s}}</td>
                    <td>{{ $ticket->date_e}}</td>
                    <td><a href="{{ Route('tickets.edit', ['ticket' => $ticket->id]) }}"><img style="width: 30px"
                                ...
                                alt=""></a></td>
                    <td><a href="{{Route('tickets.destroy',['ticket'=>$ticket->id])}}"><img style="width: 30px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgxgk2JJECcveyd80tbCtE3TwsNj-WlmUApw&usqp=CAU" alt=""></a></td>
                </tr>
            @endforeach
        </tbody>
    </table>
