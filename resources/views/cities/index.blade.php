...
<body>
        ...
        <tbody>
            @foreach ($cities as $city)
                <tr>
                    ...
                    <td>{{ $city->name }}</td>
                    <td>{{ $city->country }}</td>
                    <td><a href="{{ Route('cities.edit', ['city' => $city->id]) }}"><img style="width: 30px"
                                ...
                                alt=""></a></td>
                    <td><a href="{{Route('cities.destroy',['city'=>$city->id])}}"><img style="width: 30px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgxgk2JJECcveyd80tbCtE3TwsNj-WlmUApw&usqp=CAU" alt=""></a></td>
                </tr>
            @endforeach
        </tbody>
    </table>
    <br>
    <button>
        <a href="{{route('cities.create')}}">Add Company</a>
    </button>
</body>
